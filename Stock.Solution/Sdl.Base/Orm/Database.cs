...
namespace Sdl.Base.Orm
{
    ...
    public interface IDatabase : IDisposable
    {
        ...
        IEnumerable<T> ExecuteStoredProcedure<T>(string procName, params IDataParameter[] parms) where T : class;
    ...
    public class Database : IDatabase
    {
        ...
        //SqlServerHelper SqlHelper { get; set; }
        public void Dispose()
        {
        ...
        {
            //DataSet ds = SqlHelper.ExcuteDataSet(sql, parms);
            //return ds;
            return null;
        }
        public object ExecuteScalar(string sql, Dictionary<string, object> parms = null)
        {
            //var result = SqlHelper.ExecuteScalar(sql, parms);
            //return result;
            return null;
        }
        public IDataReader ExecuteReader(string sql, Dictionary<string, object> parms = null)
        {
            //IDataReader dr = null;
        ...
        {
            int result = 0;
            //result = SqlHelper.ExecuteNonQuery(sql, parms);
            return result;
        }
